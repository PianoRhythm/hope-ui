import{n as f,s as b,c as e,m as x,F as y,e as w,w as $,B as S,S as A,A as s,r as W,o as z,p as a,C as n,k as u,N as g,q as k,j as I}from"./index-BofjwYqB.js";import{C as l}from"./CodeSnippet-BKP0Tx3k.js";import{P as B,a as v}from"./PageTitle-nNR5DJyW.js";import{S as t}from"./SectionSubtitle--Rm4ph3k.js";import{S as i}from"./SectionTitle-DtOlKeb8.js";import"./Footer-CdYItjK8.js";function o(h){const c=f(),[p,r]=b(h,["scale"]);return e(W,x({templateColumns:{"@initial":"repeat(2, minmax(0, 1fr))","@md":"repeat(3, minmax(0, 1fr))"},gap:"$6"},r,{get children(){return e(y,{get each(){return p.scale},children:d=>e(w,{get children(){return e($,{spacing:"$3",get children(){return[e(S,{boxSize:{"@initial":"$10","@sm":"$12"},rounded:"$md",shadow:"$inner",get bg(){return c().colors[d.token].value}}),e(A,{alignItems:"flex-start",get children(){return[e(s.span,{fontSize:"$sm",fontWeight:"$semibold",get children(){return d.name}}),e(s.span,{fontSize:"$sm",textTransform:"uppercase",get children(){return c().colors[d.token].value}})]}})]}})}})})}}))}const N=`<Box bg="$primary9" w="$40" p="$4" color="$whiteAlpha12">
  This is the Box
</Box>`,C=`// example theme object
export default {
  colors: {
    primary1: "#fefcff",
    primary2: "#fff8ff",
