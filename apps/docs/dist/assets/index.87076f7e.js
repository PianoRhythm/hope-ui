import{a1 as A,o as z,i as V,a as e,T as s,A as v,U as m,W as r,k as t,b2 as h,b3 as d,b4 as n,b5 as a,V as p,p as g,ae as y,n as U,aD as T,L as F,t as b,b6 as N}from"./index.257138b9.js";import{C as $}from"./CodeSnippet.770d5f1c.js";import{P as _,a as W}from"./PageTitle.3ce5e388.js";import{P as o}from"./Preview.680bc5b4.js";import{P as w}from"./PropsTable.ba1383de.js";import{S as l}from"./SectionSubtitle.8d9ca36f.js";import{S as u}from"./SectionTitle.01cca1ff.js";import"./Footer.69976eff.js";const Y=`import { 
  Tabs, 
  TabList, 
  Tab,
  TabPanel
  ...
  <TabPanel>2</TabPanel>
  <TabPanel>3</TabPanel>
</Tabs>`,E=`<VStack alignItems="stretch" spacing="$4">
  <For each={
...
</VStack>`,R=`<VStack alignItems="stretch" spacing="$4">
  <For each={["sm", "md", "lg"]}>
    {size => (
      <Tabs size={size}>
        <TabList>
...
</VStack>`,B=`<Tabs orientation="vertical">
  <TabList>
    <Tab>One</Tab>
    <Tab>Two</Tab>
    <Tab>Three</Tab>
...
}`,Q=`const config: HopeThemeConfig = {
  components: {
    Tabs: {
      baseStyle: {
