import{s as f,a as e,m as x,r as k,v as w,w as u,x as l,y as T,p as v,z as h,E as B,o as S,i as _,T as i,j as m,J as g,k as p,e as y,L as $}from"./index.c286ed2e.js";import{C as s}from"./CodeSnippet.09eb96d9.js";import{P as z,a as C}from"./PageTitle.adcff517.js";import{P as b}from"./Preview.7d2f7afd.js";import{S as o}from"./SectionSubtitle.94b6ceda.js";import{S as P}from"./SectionTitle.c2f8079a.js";import"./Footer.11a1bc70.js";function t(d){const[n,c]=f(d,["items"]);return e(B.div,x({overflowX:"auto"},c,{get children(){return e(k,{dense:!0,get children(){return[e(w,{bg:"$neutral2",get children(){return e(u,{get children(){return[e(l,{children:"Prop"}),e(l,{children:"CSS property"}),e(l,{css:{whiteSpace:"nowrap"},children:"Theme token"})]}})}}),e(T,{color:"$primary11",fontFamily:"$mono",get children(){return e(v,{get each(){return n.items},children:a=>e(u,{get children(){return[e(h,{get children(){return a.prop}}),e(h,{get children(){return a.cssProperty}}),e(h,{get color(){return a.themeToken?"inherit":"$neutral12"},get children(){return a.themeToken||"none"}})]}})})}})]}})}}))}const R=`<Button as="a" target="_blank" href="https://solidjs.com">
  Go to SolidJS website
</Button>`,L=`import { Link } from "solid-app-router";

<Button as={Link} href="/">
  Back to home
</Button>`,F=`import { Box } from "@hope-ui/solid"
...
<Box border="1px" borderColor="$neutral6">
  Card
</Box>`,D=`import { Button } from "@hope-ui/solid"
...
<Button borderTopRadius="$md">Button 3</Button>`,M=`import { Box } from "@hope-ui/solid"
...
<Box pos="fixed" w="100%" zIndex={2}>
  Fixed with zIndex
</Box>`,J=`import { Box } from "@hope-ui/solid"

// use \`theme().shadows.md\`
<Box boxShadow="$md">
  md
</Box>
`,O=`import { Button } from "@hope-ui/solid"
