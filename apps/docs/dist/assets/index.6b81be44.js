import{M as f,s as b,a as e,m as x,p as y,G as w,H as $,B as A,V as S,E as m,N as W,o as z,i as I,T as a,k as n,A as u,j as g,J as k}from"./index.b7c0b293.js";import{C as i}from"./CodeSnippet.0aa68d1a.js";import{P as v,a as B}from"./PageTitle.ab769c39.js";import{S as t}from"./SectionSubtitle.5b3500d4.js";import{S as l}from"./SectionTitle.59dfdbf2.js";import"./Footer.a00b0e9e.js";function o(h){const c=f(),[p,r]=b(h,["scale"]);return e(W,x({templateColumns:{"@initial":"repeat(2, minmax(0, 1fr))","@md":"repeat(3, minmax(0, 1fr))"},gap:"$6"},r,{get children(){return e(y,{get each(){return p.scale},children:d=>e(w,{get children(){return e($,{spacing:"$3",get children(){return[e(A,{boxSize:{"@initial":"$10","@sm":"$12"},rounded:"$md",shadow:"$inner",get bg(){return c().colors[d.token].value}}),e(S,{alignItems:"flex-start",get children(){return[e(m.span,{fontSize:"$sm",fontWeight:"$semibold",get children(){return d.name}}),e(m.span,{fontSize:"$sm",textTransform:"uppercase",get children(){return c().colors[d.token].value}})]}})]}})}})})}}))}const N=`<Box bg="$primary9" w="$40" p="$4" color="$whiteAlpha12">
  This is the Box
