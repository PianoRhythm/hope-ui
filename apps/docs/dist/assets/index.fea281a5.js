import{T as f,s as b,c as e,m as x,F as y,e as w,S as $,A as S,h as A,R as s,G as W,o as z,d as a,C as n,Q as u,M as g,D as k,n as I}from"./index.65470585.js";import{C as l}from"./CodeSnippet.f7739050.js";import{P as v,a as B}from"./PageTitle.a7317606.js";import{S as t}from"./SectionSubtitle.07878c29.js";import{S as i}from"./SectionTitle.613f5b08.js";import"./Footer.4711f8eb.js";function o(h){const c=f(),[p,r]=b(h,["scale"]);return e(W,x({templateColumns:{"@initial":"repeat(2, minmax(0, 1fr))","@md":"repeat(3, minmax(0, 1fr))"},gap:"$6"},r,{get children(){return e(y,{get each(){return p.scale},children:d=>e(w,{get children(){return e($,{spacing:"$3",get children(){return[e(S,{boxSize:{"@initial":"$10","@sm":"$12"},rounded:"$md",shadow:"$inner",get bg(){return c().colors[d.token].value}}),e(A,{alignItems:"flex-start",get children(){return[e(s.span,{fontSize:"$sm",fontWeight:"$semibold",get children(){return d.name}}),e(s.span,{fontSize:"$sm",textTransform:"uppercase",get children(){return c().colors[d.token].value}})]}})]}})}})})}}))}const C=`<Box bg="$primary9" w="$40" p="$4" color="$whiteAlpha12">
  This is the Box
