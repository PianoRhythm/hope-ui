import{T as f,s as b,c as e,m as x,F as y,i as w,S as $,H as S,h as A,R as s,G as W,o as z,d as a,C as n,Q as u,M as g,D as k,q as I}from"./index.5fab0308.js";import{C as i}from"./CodeSnippet.0a69b940.js";import{P as v,a as B}from"./PageTitle.fca7b064.js";import{S as t}from"./SectionSubtitle.cc8e906a.js";import{S as l}from"./SectionTitle.35eb7e89.js";import"./Footer.dc4a5085.js";function o(h){const c=f(),[p,r]=b(h,["scale"]);return e(W,x({templateColumns:{"@initial":"repeat(2, minmax(0, 1fr))","@md":"repeat(3, minmax(0, 1fr))"},gap:"$6"},r,{get children(){return e(y,{get each(){return p.scale},children:d=>e(w,{get children(){return e($,{spacing:"$3",get children(){return[e(S,{boxSize:{"@initial":"$10","@sm":"$12"},rounded:"$md",shadow:"$inner",get bg(){return c().colors[d.token].value}}),e(A,{alignItems:"flex-start",get children(){return[e(s.span,{fontSize:"$sm",fontWeight:"$semibold",get children(){return d.name}}),e(s.span,{fontSize:"$sm",textTransform:"uppercase",get children(){return c().colors[d.token].value}})]}})]}})}})})}}))}const C=`<Box bg="$primary9" w="$40" p="$4" color="$whiteAlpha12">
  This is the Box
