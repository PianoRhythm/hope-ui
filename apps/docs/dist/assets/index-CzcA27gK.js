...
<Flex alignItems="center" justifyContent="center">
  Flex Container
</Flex>`,E=`import { Box, Grid } from "@hope-ui/solid"
...
<Grid gap={2} autoFlow="row dense">
  Grid
</Grid>`,j=`import { Box } from "@hope-ui/solid"
...
<Button borderTopRadius="$md">Button 3</Button>`,O=`import { Box } from "@hope-ui/solid"
...
<Box pos="fixed" w="100%" zIndex={2}>
  Fixed with zIndex
</Box>`,D=`import { Box } from "@hope-ui/solid"

// use \`theme().shadows.md\`
<Box boxShadow="$md">
  md
</Box>
`,Y=`import { Button } from "@hope-ui/solid"
