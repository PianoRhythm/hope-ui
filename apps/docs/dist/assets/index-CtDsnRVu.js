import{Y as A,o as z,c as e,i as s,K as v,J as m,Q as r,t as b,C as t,b4 as h,b5 as d,b6 as n,b7 as a,d as p,q as g,ab as y,ap as V,aF as T,L as U,b8 as F,p as Y}from"./index-Nxbfex4q.js";import{C as $}from"./CodeSnippet-BKIkSwFL.js";import{P as _,a as W}from"./PageTitle-D0rjqxl5.js";import{P as o}from"./Preview-Dv-XfG_3.js";import{P as w}from"./PropsTable-b7KBJ81X.js";import{S as l}from"./SectionSubtitle-BnAf6Y1E.js";import{S as u}from"./SectionTitle-D4b_6ZYs.js";import"./Footer-DCmuVtpk.js";const K=`import { 
  Tabs, 
  TabList, 
  Tab,
  TabPanel
} from "@hope-ui/solid"`,R=`<Tabs>
  <TabList>
    <Tab>One</Tab>
    <Tab>Two</Tab>
    <Tab>Three</Tab>
  ...
  <TabPanel>2</TabPanel>
  <TabPanel>3</TabPanel>
</Tabs>`,j=`<VStack alignItems="stretch" spacing="$4">
  <For each={
...
</VStack>`,E=`<VStack alignItems="stretch" spacing="$4">
  <For each={["sm", "md", "lg"]}>
    {size => (
      <Tabs size={size}>
        <TabList>
...
</VStack>`,N=`function ControlledExample() {
...
}`,X=`const config: HopeThemeConfig = {
  components: {
    Tabs: {
      baseStyle: {
