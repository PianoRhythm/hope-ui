 ...
 */
export type HopeProps = StyleProps & ClassProps & HtmlTooltipProps & {
    __baseStyle?: SystemStyleObject;
};
/**
 * Enhance props of a SolidJS component or JSX element with Hope UI props.
 */
export type HTMLHopeProps<C extends ElementType, AdditionalProps = {}> = OverrideProps<ParentProps<PropsOf<C>>, HopeProps & AdditionalProps & {
    as?: C;
}>;
/**
 * A hope-enabled component that accept style props.
 */
export type HopeComponent<T extends ElementType, P = {}> = <C extends ElementType = T>(props: HTMLHopeProps<C, P>) => JSX.Element;
/**
 ...
 */
export type HopeFactory = <T extends ElementType>(component: T, styleOptions?: HopeFactoryStyleOptions<T>) => HopeComponent<T>;
/**
