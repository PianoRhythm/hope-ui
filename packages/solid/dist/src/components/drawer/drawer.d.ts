...
export type DrawerProps = OverrideProps<Omit<ModalProps, "scrollBehavior" | "centered" | "motionPreset">, DrawerOptions>;
type ThemeableDrawerOptions = Pick<DrawerProps, "placement" | "size" | "fullHeight" | "disableMotion" | "blockScrollOnMount" | "closeOnEsc" | "closeOnOverlayClick" | "preserveScrollBarGap" | "trapFocus">;
