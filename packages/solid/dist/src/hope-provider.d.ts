...
export declare function useTheme(): Accessor<string & {
    ...
    colors: {
        ...
        tooltipContent: import('@stitches/core/types/theme').Token<"tooltipContent", string, "colors", "hope">;
        tooltipArrow: import('@stitches/core/types/theme').Token<"tooltipArrow", string, "colors", "hope">;
    ...
    sizes: {
        ...
        containerDesktopS: import('@stitches/core/types/theme').Token<"containerDesktopS", string, "sizes", "hope">;
        containerMobileS: import('@stitches/core/types/theme').Token<"containerMobileS", string, "sizes", "hope">;
        containerMobileM: import('@stitches/core/types/theme').Token<"containerMobileM", string, "sizes", "hope">;
        containerMobileL: import('@stitches/core/types/theme').Token<"containerMobileL", string, "sizes", "hope">;
