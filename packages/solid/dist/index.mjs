import { isServer as Mt, createComponent as i, Dynamic as Ct, mergeProps as b, Portal as it, ssr as le, ssrHydrationKey as ce, ssrAttribute as j, escape as Q } from "solid-js/web";
import { createContext as ae, mergeProps as Z, createSignal as oe, createEffect as Se, useContext as re, splitProps as v, createMemo as we, Show as M, createUniqueId as de, onMount as pe, onCleanup as be, children as lt, createRenderEffect as Hs, Switch as Ar, Match as $t, on as ft, For as Er, Index as As } from "solid-js";
import { createStore as ie } from "solid-js/store";
import { createStitches as Es, defaultThemeMap as Os } from "@stitches/core";
import Cr from "lodash.merge";
import { offset as yt, flip as wt, shift as _t, autoUpdate as Rt, computePosition as Wt, inline as Or, arrow as Mr, hide as Rr, size as Ms } from "@floating-ui/dom";
import { useFloating as Rs } from "solid-floating-ui";
import { Transition as Me, TransitionGroup as Ws } from "solid-transition-group";
...
const ni = {
  ...
  [`.${ge.fade}-enter, .${ge.fade}-exit-to`]: {
    opacity: 0
  },
  [`.${ge.fade}-enter-to, .${ge.fade}-exit`]: {
    opacity: 1
  },
  ...
  [`.${ge.fadeInBottom}-enter, .${ge.fadeInBottom}-exit-to`]: {
    opacity: 0,
    transform: "translateY(16px)"
  },
  [`.${ge.fadeInBottom}-enter-to, .${ge.fadeInBottom}-exit`]: {
    opacity: 1,
    transform: "translateY(0)"
  },
  [`.${ge.fadeInBottom}-enter-active`]: {
    transitionProperty: "opacity, transform",
    transitionDuration: "300ms",
    transitionTimingFunction: "ease-out"
  },
  [`.${ge.fadeInBottom}-exit-active`]: {
    transitionProperty: "opacity, transform",
    transitionDuration: "200ms",
    transitionTimingFunction: "ease-in"
  },
  [`.${ge.scale}-enter, .${ge.scale}-exit-to`]: {
    opacity: 0,
    transform: "scale(0.95)"
  },
  [`.${ge.scale}-enter-to, .${ge.scale}-exit`]: {
    opacity: 1,
    transform: "scale(1)"
  },
  [`.${ge.scale}-enter-active`]: {
    transitionProperty: "opacity, transform",
    transitionDuration: "300ms",
    transitionTimingFunction: "ease-out"
  },
  [`.${ge.scale}-exit-active`]: {
    transitionProperty: "opacity, transform",
    transitionDuration: "200ms",
    transitionTimingFunction: "ease-in"
  }
...
const el = Ne({
  ...Tt(Fe.scaleTopLeft, "top left"),
  ...Tt(Fe.scaleTopRight, "top right"),
  ...Tt(Fe.scaleBottomLeft, "bottom left"),
  ...Tt(Fe.scaleBottomRight, "bottom right")
}), tl = S({
  appearance: "none",
  display: "inline-flex",
  alignItems: "center",
...
const He = {
  xs: Bt({ fontSize: "$xs", lineHeight: "$4", minHeight: "$6" }),
  sm: Bt({ fontSize: "$sm", lineHeight: "$5", minHeight: "$8" }),
  md: Bt({ fontSize: "$base", lineHeight: "$6", minHeight: "$10" }),
  lg: Bt({ fontSize: "$lg", lineHeight: "$7", minHeight: "$12" })
}, yr = {
  "&:disabled": {
    opacity: 0.4,
    cursor: "not-allowed"
...
function Pp(e) {
  ...
  const r = _r("light", (T = (C = e.config) == null ? void 0 : C.lightTheme) != null ? T : {}), o = _r("dark", (y = (h = e.config) == null ? void 0 : h.darkTheme) != null ? y : {}), a = Xs((x = (w = e.config) == null ? void 0 : w.initialColorMode) != null ? x : "light"), n = a === "dark" ? o : r, [s, l] = oe(a), [c, d] = oe(n), g = () => s() === "dark", f = (A) => {
    l(A), Us(A);
  }, u = () => {
    f(g() ? "light" : "dark");
  }, p = {
...
const Jt = (e, t) => {
  const r = (o) => {
    ...
    let f = () => i(Ct, b({
      ...
      pe(() => {
        h(document.querySelector(`[unique-id="${x}"]`)), w(document.querySelector(`[unique-id="${k}"]`));
      });
      const q = (E) => {
        C(!1);
      };
      return [i(Ct, b({
        ...
        onMouseOver: (E) => {
          var I, z;
          C(!0), (z = (I = c.onMouseOver) != null ? I : c.onmouseover) == null || z(E);
        },
        onMouseOut: (E) => {
          var I, z;
          C(!1), (z = (I = c.onMouseOut) != null ? I : c.onmouseout) == null || z(E);
        },
        onBlur: (E) => {
          var I, z;
          C(!1), (z = (I = c.onBlur) != null ? I : c.onblur) == null || z(E);
        },
        onClick: (E) => {
          var I, z;
          C(!1), (z = (I = c.onClick) != null ? I : c.onclick) == null || z(E);
        },
        onMouseDown: (E) => {
          var I, z;
          C(!1), (z = (I = c.onMouseDown) != null ? I : c.onmousedown) == null || z(E);
        }
      })), p() && i(it, {
        get children() {
          return i(Ct, {
            ...
            get style() {
              ...
              return {
                ...
                top: `${(E = A.y) != null ? E : 0}px`,
                left: `${(I = A.x) != null ? I : 0}px`,
                width: "max-content"
              };
            },
            onMouseOver: () => C(!0),
            ...
            get children() {
              var E;
              return [s.__tooltip_title, ((E = s.__tooltip_show_arrow) != null ? E : !0) && i(Ct, {
                component: "div",
                style: {
                  "z-index": "var(--hope-zIndices-tooltip, 1000)"
                },
...
const R = bc(), H = R.div, Jr = "hope-accordion";
function mc(e) {
  var x;
  const t = _().Accordion, [r, o] = oe([]), [a, n] = ie({
    ...
    var q;
    let A = -1;
    s.allowMultiple && pt(a.expandedIndex) ? A = L ? [...a.expandedIndex, k] : a.expandedIndex.filter((D) => D !== k) : L ? A = k : A = -1, n("_expandedIndex", A), (q = s.onChange) == null || q.call(s, A);
  }, f = (k) => pt(a.expandedIndex) ? a.expandedIndex.includes(k) : a.expandedIndex === k, u = (k) => o((L) => [...L, k]).length - 1, p = () => {
    const k = r().length - 1;
    let L = Dt(a.focusedIndex, k, !0), A = r()[L];
    for (; A.disabled; )
      L = Dt(L, k, !0), A = r()[L];
    A.focus();
  }, C = () => {
    const k = r().length - 1;
    let L = Ht(a.focusedIndex, k, !0), A = r()[L];
    for (; A.disabled; )
      L = Ht(L, k, !0), A = r()[L];
    A.focus();
  }, T = () => {
...
function Gt(e, t) {
  const r = e.target;
  return e.button > 0 || r && !At(r).body.contains(r) ? !1 : !(t != null && t.contains(r));
}
function to(e) {
...
function _c(e) {
  ...
  }, p = () => a.expanded, C = () => a.disabled, T = () => m(s.class, no, Sc()), h = {
    state: a,
    registerButton: c,
    setFocusedIndex: d,
  ...
  return i(fo.Provider, {
    ...
    get children() {
      return i(H, b({
        ...
        get __baseStyle() {
          var T;
          return (T = t == null ? void 0 : t.baseStyle) == null ? void 0 : T.root;
        }
      }, n));
    }
  });
...
function rd(e) {
  ...
  const t = _().Button, [r] = ie({
    ...
    spacing: (T = (C = (p = t == null ? void 0 : t.defaultProps) == null ? void 0 : p.group) == null ? void 0 : C.spacing) != null ? T : "0.5rem"
...
function fr(e) {
  ...
  const t = _().Button, r = Io(), o = {
    ...
    var p, C, T, h, y, w, x, k, L, A, q, D, E, I, z;
    return m(n.class, gr, yo({
      variant: (y = (h = (p = n.variant) != null ? p : r == null ? void 0 : r.state.variant) != null ? h : (T = (C = t == null ? void 0 : t.defaultProps) == null ? void 0 : C.root) == null ? void 0 : T.variant) != null ? y : "solid",
      colorScheme: (A = (L = (w = n.colorScheme) != null ? w : r == null ? void 0 : r.state.colorScheme) != null ? L : (k = (x = t == null ? void 0 : t.defaultProps) == null ? void 0 : x.root) == null ? void 0 : k.colorScheme) != null ? A : "primary",
      size: (z = (I = (q = n.size) != null ? q : r == null ? void 0 : r.state.size) != null ? I : (E = (D = t == null ? void 0 : t.defaultProps) == null ? void 0 : D.root) == null ? void 0 : E.size) != null ? z : "md",
      loading: n.loading,
      compact: n.compact,
...
Oo.toString = () => $(Eo);
const Mo = "hope-avatar";
function pd(e) {
  var c, d, g, f, u, p, C, T, h, y, w, x, k, L;
  const t = _().Avatar, r = Lo(), o = {
    icon: (g = (d = (c = t == null ? void 0 : t.defaultProps) == null ? void 0 : c.root) == null ? void 0 : d.icon) != null ? g : (A) => i(gd, A),
    iconLabel: (p = (u = (f = t == null ? void 0 : t.defaultProps) == null ? void 0 : f.root) == null ? void 0 : u.iconLabel) != null ? p : "avatar",
    getInitials: (h = (T = (C = t == null ? void 0 : t.defaultProps) == null ? void 0 : C.root) == null ? void 0 : T.getInitials) != null ? h : ud,
    ...
    var A, q, D, E, I, z, N, U, K, te;
    return m(n.class, Mo, pr({
      size: (I = (E = (A = n.size) != null ? A : r == null ? void 0 : r.state.size) != null ? E : (D = (q = t == null ? void 0 : t.defaultProps) == null ? void 0 : q.root) == null ? void 0 : D.size) != null ? I : "md",
      withBorder: (te = (K = (z = n.withBorder) != null ? z : !!r) != null ? K : (U = (N = t == null ? void 0 : t.defaultProps) == null ? void 0 : N.root) == null ? void 0 : U.withBorder) != null ? te : !1
    }));
  };
  return i(R.span, b({
    get class() {
    ...
    get __baseStyle() {
      var A;
      return (A = t == null ? void 0 : t.baseStyle) == null ? void 0 : A.root;
    },
    get borderRadius() {
      var A;
      return (A = n.borderRadius) != null ? A : r == null ? void 0 : r.state.avatarBorderRadius;
    },
    get borderColor() {
...
function bd(e) {
  const t = _().Avatar, r = Lo(), [o, a] = v(e, ["class", "size", "withBorder"]), n = () => {
    ...
    return m(o.class, Wo, ad({
      ...
      withBorder: (T = (C = (f = o.withBorder) != null ? f : !!r) != null ? C : (p = (u = t == null ? void 0 : t.defaultProps) == null ? void 0 : u.root) == null ? void 0 : p.withBorder) != null ? T : !1
    }));
  };
  return i(R.span, b({
    get class() {
...
function Hd(e) {
  ...
  const t = `hope-checkbox-group-${de()}--checkbox`, r = _().Checkbox, [o, a] = ie({
    ...
    a("_value", C), (T = n.onChange) == null || T.call(n, C);
  }, d = () => m(n.class, Qo), g = {
    state: o,
    onChange: c
  };
...
function Qd(e) {
  var g, f, u, p, C, T, h, y, w, x, k, L, A, q, D, E, I, z, N, U;
  const t = _().Checkbox, r = Zo(), o = {
    ...
    colorScheme: (x = (w = (T = r == null ? void 0 : r.state) == null ? void 0 : T.colorScheme) != null ? w : (y = (h = t == null ? void 0 : t.defaultProps) == null ? void 0 : h.root) == null ? void 0 : y.colorScheme) != null ? x : "primary",
    size: (D = (q = (k = r == null ? void 0 : r.state) == null ? void 0 : k.size) != null ? q : (A = (L = t == null ? void 0 : t.defaultProps) == null ? void 0 : L.root) == null ? void 0 : A.size) != null ? D : "md",
    labelPlacement: (U = (N = (E = r == null ? void 0 : r.state) == null ? void 0 : E.labelPlacement) != null ? N : (z = (I = t == null ? void 0 : t.defaultProps) == null ? void 0 : I.root) == null ? void 0 : z.labelPlacement) != null ? U : "end"
...
function au(e) {
  var f, u, p, C, T, h, y, w, x;
  const t = _().CircularProgress, [r] = ie({
    get size() {
      var k, L, A, q;
      return (q = (A = e.size) != null ? A : (L = (k = t == null ? void 0 : t.defaultProps) == null ? void 0 : k.root) == null ? void 0 : L.size) != null ? q : "$12";
    },
    get thickness() {
      var k, L, A, q;
      return (q = (A = e.thickness) != null ? A : (L = (k = t == null ? void 0 : t.defaultProps) == null ? void 0 : k.root) == null ? void 0 : L.thickness) != null ? q : "$2_5";
    },
    get min() {
      var k;
    ...
    thickness: (h = (T = (C = t == null ? void 0 : t.defaultProps) == null ? void 0 : C.root) == null ? void 0 : T.thickness) != null ? h : "$2_5",
...
function su(e) {
  ...
  const t = _().CircularProgress, r = nn(), o = {
    ...
    withRoundCaps: (T = (C = (p = t == null ? void 0 : t.defaultProps) == null ? void 0 : p.indicator) == null ? void 0 : C.withRoundCaps) != null ? T : !1
...
function fn(e) {
  ...
  return pe(() => r.setBodyMounted(!0)), be(() => r.setBodyMounted(!1)), i(H, b({
    get class() {
      return n();
    },
    get id() {
...
function hn(e) {
  ...
  const t = _().Modal, r = Ve(), o = {
    ...
    icon: (h = (T = t == null ? void 0 : t.defaultProps) == null ? void 0 : T.closeButton) == null ? void 0 : h.icon
...
function Sn(e) {
  ...
  return pe(() => r.setHeaderMounted(!0)), be(() => r.setHeaderMounted(!1)), i(H, b({
    get class() {
      return n();
    },
    get id() {
...
function vu(e) {
  const t = _().Modal, r = Ve(), [o, a] = v(e, ["class"]), n = () => m(o.class, wn, Ur()), s = () => r.state.motionPreset === "none" ? "hope-none" : ge.fade;
  return i(Me, {
    get name() {
      return s();
    },
...
function $u(e) {
  ...
  return pe(() => r == null ? void 0 : r.setHasErrorMessage(!0)), be(() => r == null ? void 0 : r.setHasErrorMessage(!1)), i(M, {
    get when() {
...
function yu(e) {
  ...
  return pe(() => r == null ? void 0 : r.setHasHelperText(!0)), be(() => r == null ? void 0 : r.setHasHelperText(!1)), i(H, b({
    get id() {
      return n();
    },
    get class() {
...
function Lu(e) {
  ...
  }, o = Z(r, e), [a, n] = v(o, ["class", "as", "level", "size"]), s = () => m(a.class, On, Bu({
    size: a.size
...
function Au(e) {
  const t = _().Input, [r, o] = ie({
    get variant() {
      var u, p, C, T;
      return (T = (C = e.variant) != null ? C : (p = (u = t == null ? void 0 : t.defaultProps) == null ? void 0 : u.group) == null ? void 0 : p.variant) != null ? T : "outline";
    },
    get size() {
      var u, p, C, T;
      return (T = (C = e.size) != null ? C : (p = (u = t == null ? void 0 : t.defaultProps) == null ? void 0 : u.group) == null ? void 0 : p.size) != null ? T : "md";
    },
    hasLeftElement: !1,
    hasRightElement: !1,
    hasLeftAddon: !1,
...
const Fn = "hope-input";
function Eu(e) {
  const t = _().Input, r = kt(), o = vt(e), [a, n] = v(e, ["class", "htmlSize", "variant", "size"]), s = () => {
    var l, c, d, g, f, u, p, C, T, h, y, w, x, k;
    return m(a.class, Fn, wl({
      ...
      size: (h = (T = (u = a.size) != null ? u : r == null ? void 0 : r.state.size) != null ? T : (C = (p = t == null ? void 0 : t.defaultProps) == null ? void 0 : p.input) == null ? void 0 : C.size) != null ? h : "md",
...
function Ou(e) {
  const t = kt(), [r, o] = v(e, ["class"]), a = () => m(r.class, Vn);
  return pe(() => t == null ? void 0 : t.setHasLeftAddon(!0)), be(() => t == null ? void 0 : t.setHasLeftAddon(!1)), i(Nn, b({
    get class() {
      return a();
    },
    placement: "left",
...
function Mu(e) {
  const t = kt(), [r, o] = v(e, ["class"]), a = () => m(r.class, qn);
  return pe(() => t == null ? void 0 : t.setHasRightAddon(!0)), be(() => t == null ? void 0 : t.setHasRightAddon(!1)), i(Nn, b({
    get class() {
      return a();
    },
    placement: "right",
...
function Ru(e) {
  const t = kt(), [r, o] = v(e, ["class"]), a = () => m(r.class, Kn);
  return pe(() => t == null ? void 0 : t.setHasLeftElement(!0)), be(() => t == null ? void 0 : t.setHasLeftElement(!1)), i(jn, b({
    get class() {
      return a();
    },
    placement: "left",
...
function Wu(e) {
  const t = kt(), [r, o] = v(e, ["class"]), a = () => m(r.class, Un);
  return pe(() => t == null ? void 0 : t.setHasRightElement(!0)), be(() => t == null ? void 0 : t.setHasRightElement(!1)), i(jn, b({
    get class() {
      return a();
    },
    placement: "right",
...
function Op(e) {
  const t = `hope-menu-${de()}`, r = _().Menu, [o, a] = oe([]), [n, s] = ie({
    get triggerId() {
      var O;
      return (O = e.id) != null ? O : `${t}-trigger`;
    },
    get menuContentId() {
      return `${t}-content`;
    },
    ...
    get closeOnSelect() {
      var O, J, Y, P;
      return (P = (Y = e.closeOnSelect) != null ? Y : (J = (O = r == null ? void 0 : r.defaultProps) == null ? void 0 : O.root) == null ? void 0 : J.closeOnSelect) != null ? P : !0;
    },
    get motionPreset() {
      var O, J, Y, P, F;
      return e.motionPreset ? e.motionPreset : (J = (O = r == null ? void 0 : r.defaultProps) == null ? void 0 : O.root) != null && J.motionPreset ? (P = (Y = r == null ? void 0 : r.defaultProps) == null ? void 0 : Y.root) == null ? void 0 : P.motionPreset : (F = e.placement) != null && F.startsWith("top") ? "scale-bottom-left" : "scale-top-left";
    },
    get items() {
      return o();
    },
  ...
  const g = async () => {
    ...
    const {
      ...
      placement: (V = (F = e.placement) != null ? F : (P = (Y = r == null ? void 0 : r.defaultProps) == null ? void 0 : Y.root) == null ? void 0 : P.placement) != null ? V : "bottom-start",
      middleware: [yt((ze = (Pe = e.offset) != null ? Pe : (ve = (X = r == null ? void 0 : r.defaultProps) == null ? void 0 : X.root) == null ? void 0 : ve.offset) != null ? ze : 5), wt(), _t()]
    });
    ...
    return s("searchTimeoutId", J), s("searchString", (Y) => Y += O), n.searchString;
  }, u = (O) => {
    s("activeIndex", O);
  }, p = (O) => n.items[O].disabled, C = (O) => {
    var Y;
    u(O);
    const J = n.items[O];
    (Y = J.onSelect) == null || Y.call(J), J.closeOnSelect ? D(!1) : T();
  }, T = () => {
    l == null || l.focus();
  }, h = (O) => {
    if (!at(l, Et(O))) {
    ...
    const {
      key: J
    } = O, Y = n.items.length - 1, P = Zu(O, n.opened);
    switch (P) {
      case De.Last:
      case De.First:
      case De.Next:
      case De.Previous:
        return O.preventDefault(), u(Ju({
      ...
      case De.SelectAndClose:
        O.preventDefault(), C(n.activeIndex);
        return;
      case De.Close:
        return O.preventDefault(), D(!1);
      case De.Type:
        return x(J);
      case De.Open:
        return O.preventDefault(), D(!0);
      case De.OpenAndFocusLast:
        return O.preventDefault(), D(!0, !0, !0);
    }
  }, x = (O) => {
    D(!0);
    const J = f(O), Y = Yu(n.items, J, n.activeIndex + 1);
    Y >= 0 ? u(Y) : (window.clearTimeout(n.searchTimeoutId), s("searchString", ""));
  }, k = (O) => {
    if (n.items[O].disabled) {
      T();
      return;
    }
    C(O);
    ...
    n.opened ? (g(), l && c && (d = Rt(l, c, g))) : d == null || d();
  }, D = (O, J = !0, Y = !1) => {
    n.opened !== O && (s("opened", O), s("activeIndex", Y ? n.items.length - 1 : 0), q(), J && T());
  }, E = () => {
    u(-1);
  }, I = (O) => {
    at(l, O) || D(!1, !1);
  }, z = (O) => O === n.activeIndex, N = (O) => {
    l = O;
  }, U = (O) => {
    c = O;
  }, K = (O) => {
    ...
    const J = n.items.findIndex((P) => P.key === O.key);
    return J != -1 ? J : a((P) => [...P, O]).length - 1;
  }, xe = () => n.opened, $e = {
    state: n,
    isItemActiveDescendant: z,
    assignTriggerRef: N,
    assignContentRef: U,
    registerItem: te,
    scrollToItem: K,
  ...
  return i(ea.Provider, {
    ...
    get children() {
      return i(M, {
        ...
        get children() {
          var O;
          return (O = e.children) == null ? void 0 : O.call(e, {
            opened: xe
          });
        }
      });
...
function dg(e) {
  window.dispatchEvent(dt(fe.show, e));
}
function ug(e) {
  window.dispatchEvent(dt(fe.update, e));
}
function gg(e) {
  window.dispatchEvent(dt(fe.hide, e));
}
function fg() {
  window.dispatchEvent(dt(fe.clear));
}
function pg() {
  window.dispatchEvent(dt(fe.clearQueue));
}
function hg(e) {
  window.dispatchEvent(dt(fe.addToNotificationQueue, e));
}
function bg(e) {
  window.dispatchEvent(dt(fe.setDebugMode, e));
}
const Mp = {
  show: dg,
  update: ug,
...
function Rp(e) {
  ...
  const [t, r] = oe((q = e.debugMode) != null ? q : !1), [o] = v(e, ["children", "placement", "duration", "persistent", "closable", "limit", "zIndex"]), a = we(() => {
    ...
    var K, te, xe, $e, O, J, Y, P;
    const E = (K = D.id) != null ? K : `hope-notification-${de()}`, I = (xe = (te = D.persistent) != null ? te : o.persistent) != null ? xe : !1, z = (O = ($e = D.duration) != null ? $e : o.duration) != null ? O : yg, N = (Y = (J = D.closable) != null ? J : o.closable) != null ? Y : !0, U = (P = D.queuedNotificationUpdates) != null ? P : [];
    return a().update((F) => {
      const V = {
        ...D,
      ...
      return V.id && F.some((X) => X[0].id === V.id) ? (t() && console.log("[showNotification] Notification with the same id already exists, adding to queue", V.id, {
        ...V
      }), f(V.id, V), F) : (t() && console.log("[showNotification] Adding to list and showing notification.", {
        ...V
      }), [...F, ie(V)]);
    }), E;
  }, d = (D, E) => {
    let I = !1;
    return a().update((z) => {
      var xe, $e, O, J, Y, P, F, V, X;
      const N = z.findIndex((ve) => ve[0].id === D);
      if (N === -1)
        return z;
      const U = [...z];
      let K = U[N][0], te = U[N][1];
      return te("description", (xe = E.description) != null ? xe : K.description), te("title", ($e = E.title) != null ? $e : K.title), te("status", (O = E.status) != null ? O : K.status), te("loading", (J = E.loading) != null ? J : K.loading), te("persistent", (Y = E.persistent) != null ? Y : K.persistent), te("duration", (P = E.duration) != null ? P : K.duration), te("closable", (F = E.closable) != null ? F : K.closable), te("onClose", (V = E.onClose) != null ? V : K.onClose), te("render", (X = E.render) != null ? X : K.render), t() && console.log("[updateNotification] Notification found in list, updating", D, E), I = !0, U;
    }), I;
  }, g = (D) => {
    let E = !1;
    a().update((I) => I.filter((z) => {
      var N, U;
      return z[0].id === D ? (t() && console.log("[hideNotification] Hiding notification.", D, {
        ...z[0]
      }), z[1]("queuedNotificationUpdates", []), (U = (N = z[0]).onClose) == null || U.call(N, z[0].id), !1) : (!E && t() && (console.warn("[hideNotification] Keeping notification since it was not found in list.", D, {
        ...z[0]
      }), E = !0), !0);
    }));
  }, f = (D, E) => {
    !D || !E || a().update((I) => {
      var K;
      const z = I.findIndex((te) => te[0].id === D);
      if (z === -1)
        return t() && console.log("[addToNotificationQueue] Notification not found in list.", D, E), I;
      let N = I[z], U = N[1];
      return U("queuedNotificationUpdates", [...(K = N[0].queuedNotificationUpdates) != null ? K : [], E]), t() && console.log("[addToNotificationQueue] Notification found in list, updating", D, E), [...I];
    });
  }, u = (D) => {
    a().update((E) => {
      var U;
      const I = E.findIndex((K) => K[0].id === D);
      if (I === -1)
        return t() && console.log("[removeNotificationFromQueue] Notification not found in list.", D), E;
      let z = E[I], N = z[1];
      return N("queuedNotificationUpdates", (U = z[0].queuedNotificationUpdates) == null ? void 0 : U.slice(1)), t() && console.log("[removeNotificationFromQueue] Queued Notification found in list, removing...", D), [...E];
    });
  }, p = () => a().update(() => []), C = () => a().clearQueue(), T = () => m($g, ul({
    placement: n()
  })), h = () => {
    switch (n()) {
      case "top-start":
    ...
    debugMode: t
  }, w = (D) => c(D.detail), x = (D) => d(D.detail.id, D.detail), k = (D) => g(D.detail), L = (D) => f(D.detail.id, D.detail), A = (D) => {
    var E;
    r((E = D.detail) != null ? E : !1);
  };
  return pe(() => {
    window.addEventListener(fe.show, w), window.addEventListener(fe.update, x), window.addEventListener(fe.hide, k), window.addEventListener(fe.clear, p), window.addEventListener(fe.clearQueue, C), window.addEventListener(fe.addToNotificationQueue, L), window.addEventListener(fe.setDebugMode, A);
  }), be(() => {
    window.removeEventListener(fe.show, w), window.removeEventListener(fe.update, x), window.removeEventListener(fe.hide, k), window.removeEventListener(fe.clear, p), window.removeEventListener(fe.clearQueue, C), window.removeEventListener(fe.addToNotificationQueue, L), window.removeEventListener(fe.setDebugMode, A);
  }), i(ba.Provider, {
    value: y,
    get children() {
      return [i(it, {
                ...
                get children() {
                  return i(Er, {
                    ...
                    children: (D) => i(Cg, b(() => D[0], {
                      onCloseWithNotificationQueued: (E) => {
                        u(E.id);
                      },
                      onClose: (E) => {
                      }
...
function Wp(e) {
  const t = `hope-popover-${de()}`, r = _().Popover, [o, a] = ie({
    ...
    get initialPlacement() {
      var P, F, V, X;
      return (X = (V = e.placement) != null ? V : (F = (P = r == null ? void 0 : r.defaultProps) == null ? void 0 : P.root) == null ? void 0 : F.placement) != null ? X : "bottom";
    },
    get offset() {
      var P, F, V, X;
      return (X = (V = e.offset) != null ? V : (F = (P = r == null ? void 0 : r.defaultProps) == null ? void 0 : P.root) == null ? void 0 : F.offset) != null ? X : 8;
    },
    get arrowPadding() {
      var P, F, V, X;
      return (X = (V = e.arrowPadding) != null ? V : (F = (P = r == null ? void 0 : r.defaultProps) == null ? void 0 : P.root) == null ? void 0 : F.arrowPadding) != null ? X : 8;
    },
    get openDelay() {
      var P, F, V, X;
      return (X = (V = e.openDelay) != null ? V : (F = (P = r == null ? void 0 : r.defaultProps) == null ? void 0 : P.root) == null ? void 0 : F.openDelay) != null ? X : 0;
    },
    get closeDelay() {
      var P, F, V, X;
      return (X = (V = e.closeDelay) != null ? V : (F = (P = r == null ? void 0 : r.defaultProps) == null ? void 0 : P.root) == null ? void 0 : F.closeDelay) != null ? X : 100;
    },
    get motionPreset() {
      var P, F, V, X;
      return (X = (V = e.motionPreset) != null ? V : (F = (P = r == null ? void 0 : r.defaultProps) == null ? void 0 : P.root) == null ? void 0 : F.motionPreset) != null ? X : "scale";
    },
    get closeOnBlur() {
      var P, F, V, X;
      return (X = (V = e.closeOnBlur) != null ? V : (F = (P = r == null ? void 0 : r.defaultProps) == null ? void 0 : P.root) == null ? void 0 : F.closeOnBlur) != null ? X : !0;
    },
    get closeOnEsc() {
      var P, F, V, X;
      return (X = (V = e.closeOnEsc) != null ? V : (F = (P = r == null ? void 0 : r.defaultProps) == null ? void 0 : P.root) == null ? void 0 : F.closeOnEsc) != null ? X : !0;
    },
    get trapFocus() {
      var P, F, V, X;
      return (X = (V = e.trapFocus) != null ? V : (F = (P = r == null ? void 0 : r.defaultProps) == null ? void 0 : P.root) == null ? void 0 : F.trapFocus) != null ? X : !1;
    }
  });
  let n, s, l, c, d, g, f, u;
  ...
  async function w() {
    ...
    if (!P || !l)
      return;
    const F = [yt(o.offset)];
    o.inline && F.push(Or()), F.push(wt()), F.push(_t({
    ...
    if (ve !== o.finalPlacement && a("finalPlacement", ve), !l)
      return;
    ...
    const qe = (se = Pe.arrow) == null ? void 0 : se.x, je = (We = Pe.arrow) == null ? void 0 : We.y, B = {
      ...
      bottom: "top",
      left: "right"
    }[ve.split("-")[0]], W = `${(Math.round(c.clientWidth / 2) + 1) * -1}px`;
  ...
  }, xe = (P) => a("isHovering", P), $e = (P) => a("headerMounted", P), O = (P) => a("bodyMounted", P), J = () => o.opened;
  be(() => {
...
function Bg(e) {
  const t = _().Popover, r = ut(), [o, a] = oe(!1), [n, s] = v(e, ["ref", "class", "onKeyDown", "onFocusOut", "onMouseEnter", "onMouseLeave"]), l = (h) => {
    ...
    Mt || (document.addEventListener("keydown", l), r.afterPopoverOpen());
  }, p = () => {
...
function Rg(e) {
  ...
  const t = _().Progress, [r] = ie({
    ...
    trackColor: (T = (C = (p = t == null ? void 0 : t.defaultProps) == null ? void 0 : p.root) == null ? void 0 : C.trackColor) != null ? T : "$neutral4"
...
function Fg(e) {
  const t = _().Progress, r = ka(), [o, a] = v(e, ["class", "children"]), n = () => m(o.class, Ta, Mg());
  return i(H, b({
    get class() {
      return n();
    },
...
function Zg(e) {
  const t = `hope-radio-${de()}`, r = _().Radio, o = mt(), a = Kg(), n = vt(e), [s, l] = ie({
    ...
    get variant() {
      var x, k, L, A, q, D;
      return (D = (q = (k = e.variant) != null ? k : (x = a == null ? void 0 : a.state) == null ? void 0 : x.variant) != null ? q : (A = (L = r == null ? void 0 : r.defaultProps) == null ? void 0 : L.root) == null ? void 0 : A.variant) != null ? D : "outline";
    },
    get colorScheme() {
      var x, k, L, A, q, D;
      return (D = (q = (k = e.colorScheme) != null ? k : (x = a == null ? void 0 : a.state) == null ? void 0 : x.colorScheme) != null ? q : (A = (L = r == null ? void 0 : r.defaultProps) == null ? void 0 : L.root) == null ? void 0 : A.colorScheme) != null ? D : "primary";
    },
    get size() {
      var x, k, L, A, q, D;
      return (D = (q = (k = e.size) != null ? k : (x = a == null ? void 0 : a.state) == null ? void 0 : x.size) != null ? q : (A = (L = r == null ? void 0 : r.defaultProps) == null ? void 0 : L.root) == null ? void 0 : A.size) != null ? D : "md";
    },
    get labelPlacement() {
      var x, k, L, A, q, D;
      return (D = (q = (k = e.labelPlacement) != null ? k : (x = a == null ? void 0 : a.state) == null ? void 0 : x.labelPlacement) != null ? q : (A = (L = r == null ? void 0 : r.defaultProps) == null ? void 0 : L.root) == null ? void 0 : A.labelPlacement) != null ? D : "end";
    },
    get id() {
      var x;
...
var Oe = /* @__PURE__ */ ((e) => (e[e.Close = 0] = "Close", e[e.SelectAndClose = 1] = "SelectAndClose", e[e.First = 2] = "First", e[e.Last = 3] = "Last", e[e.Next = 4] = "Next", e[e.Open = 5] = "Open", e[e.Previous = 6] = "Previous", e[e.Select = 7] = "Select", e[e.Type = 8] = "Type", e))(Oe || {});
function Lr(e = [], t, r = []) {
  return e.filter((o) => o.disabled ? !1 : o.textValue.toLowerCase().indexOf(t.toLowerCase()) === 0 && r.indexOf(o.textValue) < 0);
}
function Jg(e, t, r = 0) {
...
function tf(e) {
  const t = `hope-select-${de()}`, r = _().Select, o = vt(e), [a, n] = oe(!1), [s, l] = oe([]), [c, d] = ie({
    ...
    get value() {
      var B;
      return this.isControlled ? e.value : this.multiple ? this.selectedOptions.map((W) => W.value) : (B = this.selectedOptions[0].value) != null ? B : void 0;
    },
    get multiple() {
      return e.multiple;
    },
    get baseId() {
      var B, W;
      return (W = (B = e.id) != null ? B : o.id) != null ? W : t;
    },
    get triggerId() {
    ...
    get variant() {
      var B, W, ee, se;
      return (se = (ee = e.variant) != null ? ee : (W = (B = r == null ? void 0 : r.defaultProps) == null ? void 0 : B.root) == null ? void 0 : W.variant) != null ? se : "outline";
    },
    get size() {
      var B, W, ee, se;
      return (se = (ee = e.size) != null ? ee : (W = (B = r == null ? void 0 : r.defaultProps) == null ? void 0 : B.root) == null ? void 0 : W.size) != null ? se : "md";
    },
    get motionPreset() {
      var B, W, ee, se;
      return (se = (ee = e.motionPreset) != null ? ee : (W = (B = r == null ? void 0 : r.defaultProps) == null ? void 0 : B.root) == null ? void 0 : W.motionPreset) != null ? se : "fade-in-top";
    },
    get activeDescendantId() {
  ...
  const C = async () => {
    ...
    const B = await Wt(g, f, {
      placement: "bottom",
      middleware: [yt((We = (se = e.offset) != null ? se : (ee = (W = r == null ? void 0 : r.defaultProps) == null ? void 0 : W.root) == null ? void 0 : ee.offset) != null ? We : 5), wt(), _t(), Ms({
        apply(Pt) {
          !f || Object.assign(f.style, {
            width: `${Pt.rects.reference.width}px`
          });
        }
      })]
    });
    ...
    return d("searchTimeoutId", W), d("searchString", (ee) => ee += B), c.searchString;
  }, h = () => {
    g == null || g.focus();
    ...
    if (a())
      return;
    const B = y().map((W) => c.options.find((ee) => ee.value === W)).filter(Boolean);
    d("selectedOptions", (W) => [...W, ...B]), n(!0);
  }, x = (B) => {
    d("activeIndex", B);
  }, k = (B) => c.selectedOptions.length <= 0 ? !1 : c.multiple ? !!c.selectedOptions.find((W) => Lt(B, W)) : Lt(B, c.selectedOptions[0]), L = (B) => {
    d("selectedOptions", (W) => W.filter((ee) => !Lt(B, ee)));
  }, A = (B) => {
    const W = c.options[B];
    c.multiple ? k(W) ? L(W) : d("selectedOptions", (ee) => [...ee, W]) : d("selectedOptions", [W]);
  }, q = () => {
    var B;
    return c.multiple ? c.selectedOptions.map((W) => W.value) : (B = c.selectedOptions[0].value) != null ? B : void 0;
  }, D = (B) => {
    var W;
    x(B), A(B), (W = e.onChange) == null || W.call(e, q());
  }, E = (B) => {
    var W;
    L(B), (W = e.onChange) == null || W.call(e, q()), h();
  }, I = (B) => c.options[B].disabled, z = (B) => {
    if (!at(g, Et(B))) {
      if (c.ignoreBlur) {
        d("ignoreBlur", !1);
        return;
    ...
    if (c.hasSelectedOptions && c.multiple && W === "Backspace") {
      E(c.selectedOptions[c.selectedOptions.length - 1]);
      return;
    }
    ...
    if (o.readOnly)
      return;
    Y(!0);
    const W = T(B), ee = Jg(c.options, W, c.activeIndex + 1);
    ...
    c.opened ? (C(), g && f && (p = Rt(g, f, C))) : p == null || p();
  }, Y = (B, W = !0) => {
    c.opened !== B && (d("opened", B), O(), J(), W && h());
  }, P = () => {
    x(-1);
  }, F = (B) => {
    at(g, B) || Y(!1, !1);
    ...
    const W = c.options.findIndex((se) => Lt(se, B));
    return W != -1 ? W : l((se) => [...se, B]).length - 1;
  };
  Se(ft(() => c.options, () => w(), {
    defer: !0
  })), Se(ft(() => e.value, () => {
    if (!c.isControlled)
      return;
    const W = (pt(e.value) ? e.value : [e.value]).map((ee) => c.options.find((se) => se.value === ee)).filter(Boolean);
    d("selectedOptions", W);
  }, {
    defer: !0
  })), Se(ft(() => c.opened, (B) => {
    !B || setTimeout(() => {
      const W = u == null ? void 0 : u.querySelector("[role='option'][aria-selected='true']");
      W && ze(W);
    }, 0);
  }));
  const je = {
...
const of = ke({
  viewBox: "0 0 15 15",
  path: () => le(rf, ce())
}), Oa = "hope-select__icon";
function Ma(e) {
  const t = _().Select, r = Re(), [o, a] = v(e, ["class", "rotateOnOpen"]), n = () => m(o.class, Oa, Hl(o.rotateOnOpen ? {
...
function nf(e) {
  const t = _().Select, [r, o] = oe(), [a, n] = v(e, ["class", "children"]), s = () => m(a.class, Wa, Ol()), l = {
    setAriaLabelledBy: o
  };
...
function ss(e) {
  const t = _().Select, r = Re(), [o, a] = v(e, ["class", "children"]), n = () => m(o.class, ir, Yr()), s = () => m(o.class, ir, zl({
    ...
    var d;
    return It(o) ? (d = o.children) == null ? void 0 : d.call(o, {
...
function Ot(e) {
  ...
  return Se(ft(() => n.loaded, (c, d) => r(d === !0 ? "none" : `${cl()} ${n.fadeDuration}`), {
    defer: !0
  })), i(M, {
    get when() {
      return n.loaded;
...
function Bf(e) {
  ...
  const t = _().Switch, r = {
    ...
    size: (y = (h = (T = t == null ? void 0 : t.defaultProps) == null ? void 0 : T.root) == null ? void 0 : h.size) != null ? y : "md",
  ...
  return i(If, b({
    ...
    children: ({
      ...
      get __baseStyle() {
        var A;
        return (A = t == null ? void 0 : t.baseStyle) == null ? void 0 : A.label;
      },
      get ["data-focus"]() {
        return L()["data-focus"];
      },
      ...
      get __baseStyle() {
        var A;
        return (A = t == null ? void 0 : t.baseStyle) == null ? void 0 : A.control;
      },
      get ["data-focus"]() {
        return L()["data-focus"];
      },
...
const hs = "hope-td";
function Ff(e) {
  const t = _().Table, r = Yt(), [o, a] = v(e, ["class", "numeric"]), n = () => m(o.class, hs, Of({
    dense: r.dense,
    numeric: o.numeric
  }));
  return i(H, b({
...
function Yf(e) {
  ...
  const t = `hope-tabs-${de()}`, r = _().Tabs, [o, a] = oe([]), [n, s] = oe([]), [l, c] = ie({
    _selectedIndex: (E = e.defaultIndex) != null ? E : 0,
    get isControlled() {
      return e.index !== void 0;
    },
    get selectedIndex() {
    ...
    get keepAlive() {
      var I, z, N, U;
      return (U = (N = e.keepAlive) != null ? N : (z = (I = r == null ? void 0 : r.defaultProps) == null ? void 0 : I.root) == null ? void 0 : z.keepAlive) != null ? U : !1;
    },
    get alignment() {
      var I, z, N, U;
      return (U = (N = e.alignment) != null ? N : (z = (I = r == null ? void 0 : r.defaultProps) == null ? void 0 : I.root) == null ? void 0 : z.alignment) != null ? U : "start";
    },
    get variant() {
      var I, z, N, U;
      return (U = (N = e.variant) != null ? N : (z = (I = r == null ? void 0 : r.defaultProps) == null ? void 0 : I.root) == null ? void 0 : z.variant) != null ? U : "underline";
    },
    get colorScheme() {
      var I, z, N, U;
      return (U = (N = e.colorScheme) != null ? N : (z = (I = r == null ? void 0 : r.defaultProps) == null ? void 0 : I.root) == null ? void 0 : z.colorScheme) != null ? U : "primary";
    },
    get size() {
      var I, z, N, U;
      return (U = (N = e.size) != null ? N : (z = (I = r == null ? void 0 : r.defaultProps) == null ? void 0 : I.root) == null ? void 0 : z.size) != null ? U : "md";
    },
    get fitted() {
      var I, z, N, U;
      return (U = (N = e.fitted) != null ? N : (z = (I = r == null ? void 0 : r.defaultProps) == null ? void 0 : I.root) == null ? void 0 : z.fitted) != null ? U : !1;
    }
    ...
    var z;
    c("_selectedIndex", I), (z = d.onChange) == null || z.call(d, I);
  }, C = (I) => I === l.selectedIndex, T = (I) => `${l.baseId}--tab-${I}`, h = (I) => `${l.baseId}--tabpanel-${I}`, y = (I) => a((z) => [...z, I]).length - 1, w = (I) => s((z) => [...z, I]).length - 1, x = () => {
    const I = o().length - 1;
    let z = Dt(l.selectedIndex, I, !0), N = o()[z];
    for (; N.disabled; )
      z = Dt(z, I, !0), N = o()[z];
    N.focus();
  }, k = () => {
    const I = o().length - 1;
    let z = Ht(l.selectedIndex, I, !0), N = o()[z];
    for (; N.disabled; )
      z = Ht(z, I, !0), N = o()[z];
    N.focus();
  }, L = () => {
    var I;
    (I = o().find((z) => !z.disabled)) == null || I.focus();
  }, A = () => {
    var I;
    (I = u().find((z) => !z.disabled)) == null || I.focus();
  }, q = () => m(d.class, xs, Kf({
...
function np(e) {
  var g, f, u, p, C, T, h, y, w;
  const t = _().Tag, r = {
    variant: (u = (f = (g = t == null ? void 0 : t.defaultProps) == null ? void 0 : g.root) == null ? void 0 : f.variant) != null ? u : "subtle",
    colorScheme: (T = (C = (p = t == null ? void 0 : t.defaultProps) == null ? void 0 : p.root) == null ? void 0 : C.colorScheme) != null ? T : "neutral",
...
function pp(e) {
  var O, J, Y, P, F, V, X, ve, Pe, ze, qe, je, B, W, ee, se, We, Pt;
  const t = `hope-tooltip-${de()}`, r = _().Tooltip, o = {
    id: t,
    placement: (J = (O = r == null ? void 0 : r.defaultProps) == null ? void 0 : O.placement) != null ? J : "bottom",
    offset: (P = (Y = r == null ? void 0 : r.defaultProps) == null ? void 0 : Y.offset) != null ? P : 8,
    withArrow: (V = (F = r == null ? void 0 : r.defaultProps) == null ? void 0 : F.withArrow) != null ? V : !1,
    arrowSize: (ve = (X = r == null ? void 0 : r.defaultProps) == null ? void 0 : X.arrowSize) != null ? ve : 8,
    ...
    closeDelay: (W = (B = r == null ? void 0 : r.defaultProps) == null ? void 0 : B.closeDelay) != null ? W : 0,
    closeOnClick: (se = (ee = r == null ? void 0 : r.defaultProps) == null ? void 0 : ee.closeOnClick) != null ? se : !0,
    closeOnMouseDown: (Pt = (We = r == null ? void 0 : r.defaultProps) == null ? void 0 : We.closeOnMouseDown) != null ? Pt : !1
  ...
  let f, u, p, C;
  const T = () => n.opened !== void 0, h = () => T() ? !!n.opened : l(), y = () => m(n.class, Ds, Vl()), w = () => m(fp, ql());
  let x;
  ...
  async function A() {
    ...
    n.inline && gt.push(Or()), gt.push(wt()), gt.push(_t()), n.withArrow && u && gt.push(Mr({
      element: u,
  ...
  const q = () => {
    var ne;
    T() || c(!0), (ne = n.onOpen) == null || ne.call(n), A();
  }, D = () => {
    var ne;
    T() || c(!1), (ne = n.onClose) == null || ne.call(n);
  }, E = () => {
    ...
    const ne = L();
    ne.addEventListener("mouseenter", E), ne.addEventListener("focus", E), ne.addEventListener("click", z), ne.addEventListener("mousedown", N), ne.addEventListener("mouseleave", I), ne.addEventListener("blur", I);
  }, te = () => {
    const ne = L();
    ne.removeEventListener("mouseenter", E), ne.removeEventListener("focus", E), ne.removeEventListener("click", z), ne.removeEventListener("mousedown", N), ne.removeEventListener("mouseleave", I), ne.removeEventListener("blur", I);
  }, xe = () => {
    Mt || !f || (document.addEventListener("keydown", U), x = Rt(L(), f, A));
  }, $e = () => {
...
export {
  ...
  jn as InputElement,
  Au as InputGroup,
  Ou as InputLeftAddon,
  Ru as InputLeftElement,
  Mu as InputRightAddon,
